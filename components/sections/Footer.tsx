                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <a href="tel:+919824838067" className="text-white hover:text-[#0052FF] transition-colors duration-300 font-medium text-sm">+91 98248 38067</a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 group">
                      ...
                      <div>
                        ...
                        <p className="text-white font-medium text-sm">Ahmedabad, Gujarat, India</p>
                      </div>
                    </div>
                  </div>
                </div>
