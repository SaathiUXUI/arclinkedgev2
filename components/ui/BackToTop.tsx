    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 group inline-flex overflow-hidden text-sm font-semibold bg-[#0A0A0B] text-[#F5F5F7] hover:bg-white/[0.08] hover:backdrop-blur-md hover:scale-[1.02] active:scale-100 cursor-pointer transition-all duration-300 ease-out shadow-lg"
          style={{
