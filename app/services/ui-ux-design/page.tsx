...
export const metadata: Metadata = {
  title: "UI/UX Design Services in New York, London, Dubai & Bangalore | User-Centered Products",
  description:
    "Premium UI/UX design services in New York, London, Dubai & Bangalore. We design intuitive, beautiful interfaces that drive engagement, reduce churn, and increase conversions.",
  alternates: { canonical: PAGE_URL },
  keywords: [
    "UI/UX design services New York, London, Dubai & Bangalore",
  ...
  openGraph: {
    type: "website",
    url: PAGE_URL,
    title: "UI/UX Design Services in New York, London, Dubai & Bangalore | Arclink Edge",
    description:
  ...
  twitter: {
    ...
    title: "UI/UX Design Services in New York, London, Dubai & Bangalore | Arclink Edge",
    description:
      "Premium UI/UX design services in New York, London, Dubai & Bangalore. We design interfaces that increase user engagement and conversions.",
...
function JsonLd() {
  ...
  const serviceSchema = {
    ...
    url: PAGE_URL,
    description:
      "Premium UI/UX design services in New York, London, Dubai & Bangalore. We design interfaces that are beautiful, intuitive, and built to increase user engagement.",
      ...
      <main id="main-content" className="overflow-x-clip bg-black text-[#F5F5F7]">
        ...
        <SharedInsidePageSections sanityLogos={sanityLogos} sanityTestimonials={sanityTestimonials} faqs={faqs}
          technology={{
            ...
            description: "We utilize the best design and prototyping software to create high-fidelity, production-ready interfaces.",
            categories: categorizedTech,
            additionalLabel: "Additional Capabilities",
            additionalTitle: "Everything needed to test, validate, and document.",
