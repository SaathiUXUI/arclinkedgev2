    ...
    <div className="relative border border-white/10 bg-[#0A0A0F]/60 p-8 backdrop-blur-xl lg:p-10">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-2xl font-medium tracking-tight" style={{ fontFamily: "var(--font-inter-tight)", letterSpacing: "-0.04em" }}>Pricing</h3>
        ...
        {/* Price Display */}
        <div className="border border-white/5 bg-white/[0.015] p-6">
          <span className="text-[0.68rem] font-bold uppercase tracking-[0.16em] text-white/40">
            {isMonthly ? "Dedicated Monthly" : "Hourly Retainer"}
          </span>
          <p className="mt-3 text-5xl font-medium text-[#F5F5F7]" style={{ fontFamily: "var(--font-inter-tight)", letterSpacing: "-0.04em" }}>
            {isMonthly ? monthlyRate : hourlyRate}
            <span className="text-lg text-white/30" style={{ letterSpacing: "0em" }}>{isMonthly ? "/mo" : "/hr"}</span>
          </p>
          <p className="mt-3 text-sm text-white/50">
            {isMonthly ? "160 hrs/month. Full-time dedication. Cancel anytime." : "Flexible hours. Ideal for support & part-time needs."}
          </p>
        </div>
